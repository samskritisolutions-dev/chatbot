      ...
      <div className="relative space-y-10 animate-fade-in max-w-7xl mx-auto pb-20 px-6 pt-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div className="space-y-2">
            ...
            <p className="text-gray-500 text-sm font-medium max-w-md leading-relaxed">Real-time intelligence and neural activity overview for your AI workforce.</p>
          </div>
          <div className="flex items-center gap-3">
             <button className="bg-[#0c0c0e]/50 backdrop-blur-xl border border-white/5 text-gray-400 font-bold px-6 py-4 rounded-2xl flex items-center gap-2 hover:text-white hover:border-white/10 transition-all">
                <Filter size={16} />
                Advanced Filter
             </button>
             <button className="bg-blue-600 text-white font-bold px-8 py-4 rounded-2xl flex items-center gap-2 shadow-2xl shadow-blue-600/40 hover:scale-105 active:scale-95 transition-all">
                <Calendar size={16} />
                Last 7 Days
             </button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
             <div className="bg-[#0c0c0e]/40 backdrop-blur-3xl border border-white/5 rounded-[48px] p-10 shadow-2xl relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-[300px] h-[300px] bg-blue-600/5 rounded-full blur-[100px] -mr-20 -mt-20 group-hover:bg-blue-600/10 transition-colors duration-1000" />
                
                <div className="flex items-center justify-between mb-12 relative z-10">
                   <div>
                      <h3 className="text-2xl font-black mb-1">Neural Activity</h3>
                      <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">Message Flux Over Time</p>
                   </div>
                   <div className="flex items-center gap-3">
                      ...
                      <select className="bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-[10px] font-black text-gray-300 uppercase tracking-widest focus:outline-none hover:bg-white/10 transition-all cursor-pointer">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-[#0c0c0e]/40 backdrop-blur-xl border border-white/5 rounded-[40px] p-10 shadow-2xl group hover:border-purple-500/20 transition-all duration-500">
                ...
                <div className="bg-[#0c0c0e]/40 backdrop-blur-xl border border-white/5 rounded-[40px] p-10 shadow-2xl group hover:border-amber-500/20 transition-all duration-500">
                   <div className="flex items-center justify-between mb-8">
          ...
          <div className="lg:col-span-4 space-y-8">
             <div className="bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-white/10 rounded-[48px] p-10 relative overflow-hidden group">
                <div className="absolute inset-0 bg-blue-600/5 blur-3xl group-hover:bg-blue-600/10 transition-colors duration-1000" />
                <div className="relative z-10">
                   <div className="w-14 h-14 rounded-2xl bg-blue-600/20 flex items-center justify-center text-blue-400 mb-8 shadow-inner">
                      <TrendingUp size={28} />
                   </div>
                   ...
                   <div className="space-y-3">
                      <div className="flex items-center justify-between">
                         <span className="text-[10px] font-black text-blue-500 uppercase tracking-widest">Confidence Level</span>
                      ...
                      <div className="h-2.5 w-full bg-white/5 rounded-full overflow-hidden p-0.5 border border-white/5">
                         <div className="bg-gradient-to-r from-blue-600 to-purple-600 h-full w-[92%] rounded-full shadow-[0_0_15px_rgba(37,99,235,0.5)]" />
                      </div>
                   </div>
                </div>
             </div>

             <div className="bg-[#0c0c0e]/40 backdrop-blur-xl border border-white/5 rounded-[48px] p-10 shadow-2xl">
                ...
                <button className="w-full mt-10 py-5 border border-white/5 rounded-[24px] text-[10px] font-black text-gray-500 uppercase tracking-[0.2em] hover:bg-white/5 hover:text-white transition-all duration-500">
                   Export Intelligence
                </button>
             </div>
          </div>
...
function StatCard({ title, value, trend, isUp, icon, color }) {
  ...
  return (
    <div className="bg-[#0c0c0e]/40 backdrop-blur-xl border border-white/5 rounded-[38px] p-10 shadow-2xl hover:border-white/20 transition-all duration-500 group relative overflow-hidden">
      ...
      <h4 className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em] mb-2 ml-1">{title}</h4>
   ...
   return (
      <div className="space-y-3">
         <div className="flex items-center justify-between px-1">
            ...
            <span className="text-[10px] font-black text-gray-500 uppercase">{messages} hits</span>
         </div>

  ...
  return (
    <div className="min-h-screen bg-[#050506] text-white selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-blue-600/10 rounded-full blur-[140px] opacity-50" />
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold tracking-tight">Antigravity<span className="text-blue-500">AI</span></span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/register" className="px-5 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-bold rounded-xl transition-all shadow-lg shadow-blue-600/20">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <main className="relative pt-32">
        ...
        <section className="px-6 pb-24 text-center max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[11px] font-bold uppercase tracking-widest mb-8 animate-fade-in shadow-xl shadow-blue-500/5">
            <Sparkles size={14} />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in">
            ...
            <Link href="#pricing" className="w-full sm:w-auto px-10 py-5 bg-white/5 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all flex items-center justify-center gap-2">
              Explore Plans
            </Link>
          </div>

          {/* Hero Preview */}
          <div className="mt-24 relative p-4 bg-white/5 rounded-[40px] border border-white/10 shadow-2xl animate-fade-in">
            <div className="bg-[#0c0c0e] rounded-[32px] overflow-hidden border border-white/5 aspect-video flex items-center justify-center">
            ...
            <div className="absolute -top-12 -left-12 p-6 bg-blue-600/20 backdrop-blur-2xl rounded-3xl border border-white/10 hidden lg:block animate-float">
               <BrainCircuit className="text-blue-400" size={32} />
            </div>
            <div className="absolute -bottom-12 -right-12 p-6 bg-purple-600/20 backdrop-blur-2xl rounded-3xl border border-white/10 hidden lg:block animate-float-delayed">
        ...
        <section id="features" className="px-6 py-32 bg-[#080809]">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">Everything you need to automate your customer support and lead generation.</p>
            </div>
        ...
        <section id="pricing" className="px-6 py-32">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <p className="text-gray-500 max-w-2xl mx-auto">Choose the plan that fits your growth stage.</p>
            </div>
        ...
        <section className="px-6 py-32">
          <div className="max-w-5xl mx-auto p-12 lg:p-20 bg-gradient-to-br from-blue-600 to-purple-700 rounded-[40px] text-center relative overflow-hidden shadow-2xl shadow-blue-600/20">
      ...
      <footer className="px-6 py-20 border-t border-white/5 bg-[#080809]">
...
function PricingCard({ name, price, description, features, buttonText, highlighted = false }) {
  return (
    <div className={`p-10 rounded-[40px] border flex flex-col transition-all hover:scale-[1.02] ${highlighted ? 'bg-blue-600 border-blue-400 shadow-2xl shadow-blue-600/30 text-white' : 'bg-white/[0.02] border-white/5 text-gray-300'}`}>
      <div className="mb-10">
        <h3 className={`text-lg font-black uppercase tracking-widest mb-4 ${highlighted ? 'text-white' : 'text-blue-400'}`}>{name}</h3>
        ...
        <p className={`text-sm leading-relaxed ${highlighted ? 'text-white/80' : 'text-gray-500'}`}>{description}</p>
      </div>

      <div className="space-y-4 mb-10 flex-1">
        {features.map((f, i) => (
          <div key={i} className="flex items-center gap-3 text-sm font-medium">
            <CheckCircle2 size={18} className={highlighted ? 'text-white' : 'text-blue-500'} />
